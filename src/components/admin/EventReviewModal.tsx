                ...
                <div className="bg-neutral-700 rounded-lg p-4">
                  {event.venueProofPDF ? (
                    <div className="space-y-2">
                      <button
                        onClick={() => openPDFSafely(event.venueProofPDF, 'venue-booking-proof.pdf')}
                        className="flex items-center space-x-3 text-blue-400 hover:text-blue-300 transition-colors w-full text-left"
                      >
                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
