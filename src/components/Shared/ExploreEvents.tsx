  ...
  const sampleEvents: Event[] = events || [
    {
      ...
      locationName: 'Hyderabad International Convention Centre, Hyderabad',
      price: 99,
    ...
    },
    {
      ...
      time: '18:00',
      location: 'City Park',
      locationName: 'Lumbini Park, Hyderabad',
      price: 75,
    ...
    },
    {
      ...
      time: '14:00',
      location: 'Art Studio',
      locationName: 'Kalakriti Art Gallery, Banjara Hills, Hyderabad',
      price: 45,
    ...
    },
    {
      ...
      locationName: 'Charminar, Hyderabad',
      price: 25,
